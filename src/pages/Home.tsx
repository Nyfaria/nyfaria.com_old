    ...
    return (
        <div className={state.collapsed ? "home-open" : "home-close"}>
            ...
            <div className={"home-desc"}>
                ...
                <p>Nyfaria, also known as Anthony Jones, is a well-known figure in the modding community. He creates and maintains a variety of popular mods that enhance the gameplay experience by adding new features and mechanics. Some of his notable mods includ:</p>
                <ol type={"1"}>
                    <li>Nyf's Spiders - This mod improves teh behavior of spider, allowing them to climb walls and ceilings more realistically. </li>
